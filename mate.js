...
(function() {
  ...
  Array.prototype.joinDeep = function() {
    var args;
    ...
    if (args.length <= 1) {
      ...
      return this.map((function(_this) {
        return function(arr) {
          return arr.joinDeep.apply(arr, args.slice(0, -1));
        };
      })(this)).join(args.last());
    }
  };
  ...
  String.prototype.splitDeep = function() {
    var args, arr;
    args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
    ...
    if (args.length === 2 && typeof args[1] === "number") {
      ...
      return arr.map((function(_this) {
        return function(s) {
          return s.splitDeep.apply(s, args.slice(1));
        };
      })(this));
    }
  };
          ...
          return (function() {
            ...
            xhr.onload = function() {
              ...
              response = {
                ...
                headerFields: xhr.getAllResponseHeaders().stripTrailingNewline().splitDeep("\r\n", ": ", 1).map(function(field) {
