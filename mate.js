...
(function() {
  ...
  featureLoaders.push(function() {
    ...
    return global.ObjectWithEvents = (function() {
            ...
            return funStr = funStr.replace(RegExp("" + testArgName + "\\.unit\\s*\\(\\s*(\"(?:[^\"\\\\]|\\\\.)*\"|'(?:[^'\\\\]|\\\\.)*')(?:\\s*,\\s*(\"(?:[^\"\\\\]|\\\\.)*\"|'(?:[^'\\\\]|\\\\.)*'))?\\s*\\)", "g"), function(match, p1, p2) {
              ...
              (function() {
                if (parsed.type === "equal") {
                  return newStr = "" + testArgName + ".equal(" + parsed.str1 + ", " + parsed.str2 + ", " + (p2 != null ? p2 : p1) + ")";
                }
              })();
              return newStr;
            });
  ...
  $mate.nodePackageInfo = {
    ...
    "keywords": ["test", "unit", "testing", "library", "app", "javascript", "coffeescript", "js", "coffee"],
