...
(function() {
  ...
  if (Array.from === void 0) {
    Array.from = function(arrayLike) {
      ...
      results1 = [];
      for (j = 0, len = arrayLike.length; j < len; j++) {
        m = arrayLike[j];
        results1.push(m);
      }
      return results1;
  ...
  Date.Timer = (function() {
    ...
    Timer._precision = null;

    Timer.enable = function(precision) {
      if (precision == null) {
        precision = 30;
      }
      if (Date.Timer.getEnabled()) {
        return;
      }
      Date.Timer._precision = precision;
      this._internalTimer = setInterval((function(_this) {
        return function() {
          return Date.Timer._onCheck.fire();
        };
      })(this), precision);
      return void 0;
    };
    ...
    Timer.getPrecision = function() {
      return Date.Timer._precision;
    };

    Timer.getEnabled = function() {
      return Date.Timer._precision != null;
    };
...
}, nameIndexes: {"wishlist":1,"./package.json":2}, result: initialModResult_674497323404793172}, {fun: function(exports, module, require) {
...

{
    "name": "mate",
    "version": "0.14.0",
    "description": "Array extension, ES6 shim, event, observer, test, timer, etc. It extends the native JavaScript / CoffeeScript.",
    "keywords": [
